  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-20">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-10">
        <a
          href="mailto:buxtech27@gmail.com"
          className="border border-border rounded-lg p-4 hover:border-cyan transition-colors"
        >
          <div className="text-muted text-xs mb-1">Email</div>
          <div className="text-ink font-mono-price text-sm">buxtech27@gmail.com</div>
        </a>
        <a
          href="tel:+2348123590484"
          className="border border-border rounded-lg p-4 hover:border-cyan transition-colors"
        >
          <div className="text-muted text-xs mb-1">Phone / WhatsApp</div>
          <div className="text-ink font-mono-price text-sm">0812 359 0484</div>
        </a>
      </div>
