  ...
  return (
    <header className="sticky top-0 z-50 bg-base/90 backdrop-blur border-b border-border">
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4 gap-4">
        <Link to="/" className="font-display text-2xl text-ink tracking-wider whitespace-nowrap" onClick={closeMenus}>
      ...
      {menuOpen && (
        <div className="md:hidden px-6 pb-4">
          ...
          <NavLink to="/shop" className={mobileLinkClass} onClick={closeMenus}>Shop</NavLink>
